...
class TestGameLoop(unittest.TestCase):
    ...
    def test_can_simulate(self):
        events = [StubEvent(pygame.KEYDOWN, pygame.K_SPACE), StubEvent(pygame.QUIT, None)]

        game_loop = GameLoop(self.simulation, StubRenderer(), StubEventQueue(events), StubClock())
